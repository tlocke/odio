...
A pure-Python library for the input / output of
...
>>>
>>>
>>> # Parse the document we just created. Can be ODF 1.1 or 1.2 format.
...
>>> with odio.create_text(open('test.odt', "wb"), '1.2') as txt:
...	
...     txt.append(
